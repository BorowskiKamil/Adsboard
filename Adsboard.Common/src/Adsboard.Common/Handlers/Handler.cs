...
namespace Adsboard.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<AdsboardException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<AdsboardException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (AdsboardException customException)
            {
                isFailure = true;
